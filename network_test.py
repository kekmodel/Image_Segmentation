...
class Attention_block(nn.Module):
    def __init__(self, F_g, F_l, F_int):
        ...
        self.W_g_conv = nn.Conv2d(F_g, F_int, kernel_size=1, stride=1, padding=0, bias=True)
        self.W_g_bn = nn.BatchNorm2d(F_int)
        self.W_x_conv = nn.Conv2d(F_l, F_int, kernel_size=1, stride=1, padding=0, bias=True)
