...
def main(config):
    ...
    for i in range(num_train):
        ...
        printProgressBar(i + 1, num_train, prefix='Producing train set:',
    ...
    for i in range(num_valid):
        ...
        printProgressBar(i + 1, num_valid, prefix='Producing valid set:',
                         suffix='Complete', length=50)
    ...
    for i in range(num_test):
        ...
        printProgressBar(i + 1, num_test, prefix='Producing test set:',
                         suffix='Complete', length=50)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--origin_data_path', type=str,
                        default='./data/ISIC2018_Task1-2_Training_Input')
    parser.add_argument('--origin_GT_path', type=str,
                        default='./data/ISIC2018_Task1_Training_GroundTruth')
